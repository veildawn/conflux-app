...
import { ArrowDown, ArrowUp, Activity, Cpu, RefreshCw, Network } from 'lucide-react';
          ...
          <div className="flex justify-between h-full">
            <div className="flex flex-col justify-between">
              ...
              <div className="flex gap-6 mt-4">
                <div>
                  <div className="text-[10px] uppercase text-gray-400 dark:text-gray-500 font-bold mb-1">
                    端口
                  </div>
                  <div className="text-lg font-mono font-medium text-gray-700 dark:text-gray-300">
                    {status.port}
                  </div>
                </div>
                <div>
